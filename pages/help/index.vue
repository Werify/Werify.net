  ...
  <section class="bg-white dark:bg-gray-900 rounded-sm">
    <div class="py-8 px-4 mx-auto sm:py-16 lg:px-6">
      <div class="mx-auto text-center mb-8 lg:mb-16">
        ...
        <div class="relative">
          ...
          <input
            ...
            class="block p-4 pl-12 w-full text-gray-900 bg-gray-50 rounded-sm outline-none border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <div class="p-4 rounded-sm shadow dark:bg-gray-800">
          <div
            class="flex justify-center items-center mb-4 w-10 h-10 rounded-sm bg-blue-100 dark:bg-blue-900 lg:h-12 lg:w-12">
            <svg
