        ...
        <div class="border-b dark:border-gray-700 mx-4">
          ...
          <div
            ...
            <div
              ...
              <form class="w-full md:max-w-sm flex-1 md:mr-4">
                ...
                <div class="relative">
                  ...
                  <input
                    type="search"
                    id="default-search"
                    class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-sm rounded-r-lg outline-none bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Search..."
                    required="" />
                  <button
                    type="submit"
              ...
              <div class="flex items-center space-x-4">
                <div>
                  ...
                  <div
                    id="filterDropdown"
                    class="z-10 hidden p-3 bg-white rounded-sm shadow w-56 dark:bg-gray-700">
                    <h6
            ...
            <div
              ...
              <button
                type="button"
                class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-sm text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                <svg
            ...
            <tbody>
              <tr
                ...
                <td class="px-4 py-2 whitespace-nowrap">
                  <span
                    class="bg-primary-100 text-primary-800 text-xs font-medium px-2.5 py-0.5 rounded-sm dark:bg-primary-900 dark:text-primary-300"
                    >In progress</span
                  >
                </td>
                <td class="px-4 py-2 whitespace-nowrap">
                ...
                <td
                  ...
                  <div
                    class="px-2 py-1 border dark:border-gray-600 bg-white dark:bg-gray-700 rounded-sm text-xs font-medium inline-flex items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      aria-hidden="true"
                ...
                <td class="px-4 py-2">
                  <button
                    ...
                    class="inline-flex items-center p-1 text-sm font-medium text-center text-gray-500 hover:text-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-sm focus:outline-none dark:text-gray-400 dark:hover:text-gray-100">
                    <svg
                      class="w-5 h-5"
                      aria-hidden="true"
                      fill="currentColor"
              ...
              <tr
                ...
                <td class="px-4 py-2 whitespace-nowrap">
                  <span
                    class="bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded-sm dark:bg-green-900 dark:text-green-300"
                    >Completed</span
                  >
                </td>
                <td class="px-4 py-2 whitespace-nowrap">
