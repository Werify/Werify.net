              ...
              <div
                ...
                <div
                  ...
                  <div
                    ...
                    ><select
                      id="price-to"
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm outline-none rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <th scope="col" class="p-4">
                  <div class="flex items-center">
                    <input
                      id="checkbox-all"
                      type="checkbox"
                      class="w-4 h-4 text-blue-600 bg-gray-100 rounded-sm border-gray-300 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600" />
